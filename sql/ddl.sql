...
(
    ...
    accessKey     varchar(512)                           not null comment '用户签证',
    secreteKey    varchar(512)                           not null comment '签证密钥',
...
create table my_db.interface_info
(
    id            bigint auto_increment comment '主键'
        primary key,
    name          varchar(256)                           not null comment '用户名',
    url           varchar(512)                           not null comment '接口地址',
    description   varchar(256)                           null comment '详情',
    method        varchar(256)                           not null comment '请求类型 ',
    userid        mediumtext                             not null comment '用户名',
    status        varchar(256) default '0'               not null comment '接口状态',
    requestHeader text                                   not null comment '请求头',
    respondHead   text                                   not null comment '响应头',
    updateTime    datetime     default CURRENT_TIMESTAMP not null on update CURRENT_TIMESTAMP comment '更新时间',
    createTime    datetime     default CURRENT_TIMESTAMP not null comment '创建时间',
